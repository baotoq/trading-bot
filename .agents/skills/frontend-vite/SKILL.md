...
metadata:
  ...
  domain: frontend
  triggers: Vite, vite.config, Rolldown, HMR, build tool, dev server, Vite plugin, SSR, library mode
  role: specialist
  scope: implementation
  output-format: code
  related-skills: testing-vitest, vue-best-practices, react-expert
---
